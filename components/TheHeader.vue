    ...
    <div class="container max-w-screen-2xl mx-auto px-2 py-4">
      <div class="flex justify-between items-center">
        ...
        <ul class="hidden lg:flex justify-between items-center w-1/3">
          <li v-for="(item, i) in menu" :key="i" class="text-lg font-medium py-2 px-1 mx-2 text-primary rounded">
        ...
        <div class="flex lg:hidden w-12 justify-center items-center">
          <button class="rounded-full bg-primary p-2 shadow-lg" @click="getMenu" v-on-clickaway="closeMenu">
